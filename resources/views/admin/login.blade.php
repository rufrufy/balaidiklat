...
<head>
    ...
    <style>
        :root{--primary:#072C2C;--secondary:#FF5F03;--surface:#EDEADE;--border:rgba(7,44,44,.16);--font-display:"Oswald",system-ui,sans-serif;--font-body:"Ubuntu",system-ui,sans-serif}body{min-height:100vh;margin:0;font-family:var(--font-body);background:linear-gradient(135deg,var(--primary),#0f4747);display:grid;place-items:center;color:#111827}.login-card{width:min(440px,92vw);background:var(--surface);border:1px solid var(--border);border-radius:28px;padding:34px;box-shadow:0 28px 70px rgba(0,0,0,.26)}h1{font-family:var(--font-display);color:var(--primary)}.brand-mark{width:58px;height:58px;border-radius:18px;background:#fff;color:var(--primary);display:grid;place-items:center;object-fit:contain;padding:4px}.btn-primary-enterprise{--bs-btn-bg:var(--primary);--bs-btn-border-color:var(--primary);--bs-btn-hover-bg:#0B3A3A;--bs-btn-hover-border-color:#0B3A3A;--bs-btn-color:#fff;border-radius:999px;font-weight:800;padding:.85rem 1rem}.form-control{border-radius:16px;padding:.85rem 1rem}.hint{color:#667085;font-size:.95rem}.accent{color:var(--secondary)}
    </style>
</head>
<body>
    <main class="login-card">
        <div class="d-flex align-items-center gap-3 mb-4">
            <img class="brand-mark" src="{{ asset('icon.png') }}" alt="Logo BKPP">
            <div>
