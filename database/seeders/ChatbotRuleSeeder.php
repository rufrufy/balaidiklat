...
class ChatbotRuleSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $rules = [
            ...
            ['nama' => 'Main - 1 Informasi layanan', 'keyword' => '1', 'match_type' => 'exact', 'state' => 'main_menu', 'reply_text' => null, 'action' => 'list_kamar', 'next_state' => 'pilih_jenis', 'priority' => 10],
            ['nama' => 'Main - 2 Pemesanan kamar/kelas', 'keyword' => '2', 'match_type' => 'exact', 'state' => 'main_menu', 'reply_text' => null, 'action' => 'list_kamar', 'next_state' => 'pilih_jenis', 'priority' => 11],
