<div class="table-responsive">
    <table class="table align-middle">
        <thead><tr><th>Kode</th><th>Nama</th><th>Gedung</th><th>Jenis</th><th>Kapasitas</th><th>Tersedia</th><th>Harga/Malam</th><th>Status</th><th>Aksi</th></tr></thead>
        <tbody>
            ...
            @empty
                <tr><td colspan="9" class="text-muted text-center py-4">Belum ada data kamar.</td></tr>
            @endforelse
        </tbody>
    </table>
</div>
